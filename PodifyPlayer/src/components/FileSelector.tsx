...
const FileSelector: FC<Props> = ({
  ...
  const handleDocumentSelect = async () => {
    try {
       ...
       * {
          "fileCopyUri": null,
          "name": "leva-eternity-149473.mp3",
          "size": 4636003,
          "type": "audio/mpeg",
          "uri": "content://com.android.externalstorage.documents/document/primary%3ADownload%2FAudioSharingApp%2Fleva-eternity-149473.mp3"
        }
       */
